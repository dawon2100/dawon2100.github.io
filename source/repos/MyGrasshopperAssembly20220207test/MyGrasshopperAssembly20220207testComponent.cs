...
{
    public class MyGrasshopperAssembly20220207testComponent : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public MyGrasshopperAssembly20220207testComponent()
          : base("MyGrasshopperAssembly20220207test", "HelloWorld",
            "Construct an Archimedean, or arithmetic, spiral given its radii and number of turns.",
            "Curve", "Primitive")
        {
        }

        Rhino.Geometry.Circle c = new Circle();
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("4C61CE5D-1CA0-49FF-A281-E9EDB97485E1");
    }
}