...
namespace SpiralComponent
{
    
    public class SpiralComponentComponent : GH_Component
    {
        ...
        /// </summary>
        public SpiralComponentComponent()
          : base("SpiralComponentLDW", "SpiralX",
              "JunglimX World Class Top Tier Member.",
              "JunglimX", "BLDR")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddPlaneParameter("Plane", "PP131231231P", "Base plane for spiral", GH_ParamAccess.item, Plane.WorldXY);
            pManager.AddNumberParameter("123Inner Radius", "R0123", "Inner radius for spiral", GH_ParamAccess.item, 1.0);
            pManager.AddNumberParameter("123Outer Radius", "R1123", "Outer radius for spiral", GH_ParamAccess.item, 10.0);
            pManager.AddIntegerParameter("Turns", "TTTTT", "Number of turns between radii", GH_ParamAccess.item, 10);
        ...
        {
            get { return new Guid("8e0382d0-b897-46a7-a82c-8ceebf1a1981"); }
        }
    }
}
