...
{
    public class MyProject12Component : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public MyProject12Component()
          : base("MyProject12perfect", "perfect",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Inner Radius", "R0123", "Inner radius for spiral", GH_ParamAccess.item, 1.0);
            pManager.AddNumberParameter("Outer Radius", "R1123", "Outer radius for spiral", GH_ParamAccess.item, 10.0);
        ...
        {
            get { return new Guid("1897d5cf-2505-4242-988c-6b2da206f425"); }
        }
    }
}
